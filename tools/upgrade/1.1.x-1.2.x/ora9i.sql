...
/*  Artem Rodygin           2007-06-24      bug-530: String values capacity can be decreased in   */
/*                                          Oracle to fit the actual number of characters.        */
/*------------------------------------------------------------------------------------------------*/
...
modify filter_name nvarchar2 (50) not null;
