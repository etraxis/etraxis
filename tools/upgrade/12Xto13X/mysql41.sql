...
alter table tbl_dependencies add primary key
(
    record_id,
    dependency_id
);

alter table tbl_dependencies add constraint foreign key
(
    record_id
)
