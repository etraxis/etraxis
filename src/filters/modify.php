                    ...
                    switch ($row['field_type'])
                    {
                        ...
                        case FIELD_TYPE_CHECKBOX:
                            ...
                            $xml .= '<control name="check_' . $name . '">'
                                  . '<label/>'
                                  . '<radio value="' . 1 . (try_request('check_' . $name, (int)($param1 != 0)) == 1 ? '" checked="true">' : '">') . get_html_resource(RES_ON_ID)  . '</radio>'
                                  . '<radio value="' . 0 . (try_request('check_' . $name, (int)($param1 == 0)) == 0 ? '" checked="true">' : '">') . get_html_resource(RES_OFF_ID) . '</radio>'
                                  . '</control>';
