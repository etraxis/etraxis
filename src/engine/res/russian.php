...
(
    ...
    /* 1120 */
    'право повторно открывать закрытые записи',
    ...
    'Кодировка CSV',
    'Концы строк CSV',
    'уведомлять когда запись повторно открывается',
    /* 1310 */
    'Включить фильтры',
    'Выключить фильтры',
    NULL,
    ...
    /* 1320 */
    'Свернуть все',
    'Запись повторно открыта в состоянии "%1".',
    'П/соб',
